...
var SvgAtrTable = map[string][]string{
	...
	"animate":             {"accumulate", "remove", "additive", "attributeName", "attributeType", "begin", "by", "calcMode", "dur", "end", "fill", "from", "keySplines", "keyTimes", "max", "min", "repeatCount", "repeatDur", "restart", "to", "values"},
	...
	"metadata":            {},
	"mpath":               {"href"},
	"path":                {"d", "pathLength", "fill-rule", "clip-rule", "fill"},
...
var SvgSelfClosing = []string{"animate", "animateMotion", "animateTransform", "circle", "ellipse", "feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "line", "path", "polygon", "polyline", "rect", "stop", "use", "image", "textPath", "tspan"}
