...
// Textarea -
func Textarea(tags ...LuxeGo.Content) *TextareaTag {
	return &TextareaTag{ComponentHtmlTag: &ComponentHtmlTag{Name: "textarea", Attributes: &LuxeGo.Attributes{}, Children: &tags}}
}
